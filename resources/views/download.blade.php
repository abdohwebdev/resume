...
<body>
    <div class="py-9 px-7 max-w-2xl mx-auto my-2">
        ...
        <main>
            ...
            @endif
            @if(isset($cv['links']) && count($cv['links']) > 0)
                <hr class="border-dashed mb-4 mt-3">
                <section class="flex justify-start items-center">
                    @if(isset($cv['links']['linkedin']))<a href="{{$cv['links']['linkedin']}}" target="_blank"><i class="fa-brands fa-linkedin"></i></a> @endif
                    @if(isset($cv['links']['github']))<a href="{{$cv['links']['github']}}" target="_blank"><i class="fa-brands fa-github"></i></a> @endif
                    @if(isset($cv['links']['portfolio']))<a href="{{$cv['links']['portfolio']}}" target="_blank"><i class="fa-solid fa-globe"></i></a> @endif
                </section>
            @endif
        </main>
    </div>
